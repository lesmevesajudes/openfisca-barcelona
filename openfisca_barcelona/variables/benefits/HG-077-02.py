...
class lloguer_inferior_al_maxim_per_demarcacio_HG_077_02(Variable):
    value_type = bool
    ...
    def formula(unitatDeConvivencia, period, legislation):
        ...
        lloguer_maxim_per_demarcacio = legislation(period).benefits.H.import_lloguer_maxim["HG_077_02"][demarcacio_de_lhabitatge]
...
class HG_077_02(Variable):
    ...
    def formula(unitatDeConvivencia, period, legislation):
        ...
        lloguer_inferior_al_maxim_per_demarcacio = unitatDeConvivencia("lloguer_inferior_al_maxim_per_demarcacio_HG_077_02", period)
